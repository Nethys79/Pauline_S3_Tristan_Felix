...
public class CharacterControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TEST3 = GameObject.Find("/-----UI-----/Canvas/ZENITAL Mode/Panel/Tuto");
            ...
            if (Physics.Raycast(playerCamera.ScreenPointToRay(Input.mousePosition), out hit))
            {
                ...
                if (hit.transform.tag == "3" && scriptedJourney.StatusTuto >= 5)
                {
                    ...
                    { UnityEngine.Debug.Log("vsdfjksdfvuji"); }
                        ...
                        if(tuto.TutoInt == 18) { tuto.TutoInt = 19; }
                }
    ...
    public void InteracteIn()
    {
        ...
        if (Helper == 4)
        {
            ...
            if (tuto.TutoInt == 21 && scriptedJourney.StatusTuto == 11)
            {
    ...
    public void ConfirmFinish()
    {
        ...
        if (scriptedJourney.StatusTuto == 11 && tuto.TutoInt == 20)
        {
            scriptedJourney.StatusTuto = 12;
            tuto.TutoInt = 21;
            paper1.Play();
            BureauBookPanel.SetActive(false);
            BureauBookBackButton.SetActive(false);
